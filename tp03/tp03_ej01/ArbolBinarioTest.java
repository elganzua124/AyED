...
public class ArbolBinarioTest {
	...
	public void testGetDatoRaiz() {
		assertEquals(Integer.valueOf(1), arbolBinarioA.getDatoRaiz());
		assertEquals(Integer.valueOf(1), arbolBinarioB.getDatoRaiz());
		assertEquals(Integer.valueOf(11), arbolBinarioC.getDatoRaiz());

		arbolBinarioG = new ArbolBinario<Integer>(33);
		assertEquals(Integer.valueOf(33), arbolBinarioG.getDatoRaiz());
	}

	@Test
	public void testGetHijoIzquierdo() {

		assertEquals(Integer.valueOf(2), arbolBinarioA.getHijoIzquierdo().getDatoRaiz());

	}

	@Test
	public void testGetHijoDerecho() {
		assertEquals(Integer.valueOf(5), arbolBinarioA.getHijoDerecho().getDatoRaiz());
	}
	...
	public void testFrontera() {
		 ...
		 * assertEquals(listaFronteraEsperada.elemento(1),
		 * listaFronteraDeArbolBinario.elemento(1));
		 * assertEquals(listaFronteraEsperada.elemento(2),
		 * listaFronteraDeArbolBinario.elemento(2));
		 * assertEquals(listaFronteraEsperada.elemento(3),
		 * listaFronteraDeArbolBinario.elemento(3));
		 * assertEquals(listaFronteraEsperada.elemento(4),
		 * listaFronteraDeArbolBinario.elemento(4));
		 * 
		 * 
		 * //CASO arbolBinarioC listaFronteraEsperada=new
		 * ListaEnlazadaGenerica<Integer>(); listaFronteraEsperada.agregarEn(13,1);
		 * listaFronteraEsperada.agregarEn(14,2); listaFronteraEsperada.agregarEn(8,3);
		 * 
	...
	/*
	 * @Test public void testEsMenor() {
	 * assertTrue(arbolBinarioA.esMenor(arbolBinarioB)); }
	 */

	/*
	 * @Test public void testLleno() { assertTrue(arbolBinarioA.lleno());
	 * assertFalse(arbolBinarioD.lleno()); }
	 * 
	 * 
	 * @Test public void testCompleto() { assertTrue(arbolBinarioA.completo());
	 * assertFalse(arbolBinarioC.completo()); assertTrue(arbolBinarioD.completo());
	 * }
	 */
